...
export const INITIAL_EQUIPMENTS: Equipment[] = [
  ...
  // Equipamentos SIGEO - Infraestrutura Geral
  {
    id: 'eq-sigeo-01',
    labId: 'sigeo',
    name: 'Workstations SIGEO em Operação (8 bancadas disponíveis)',
    code: 'WS-ATIVAS',
    category: 'workstation',
    status: 'disponivel',
    description: '8 computadores desktop operacionais do SIGEO (Sala 1B307) equipados para aulas práticas de SIG, Sensoriamento e Fotogrametria.',
    specs: 'Intel Core i7 / 16GB-32GB RAM / GPU RTX / SSD'
  },
  {
    id: 'eq-sigeo-02',
    labId: 'sigeo',
  ...
  // ============================================================================
  // WORKSTATIONS SIGEO (Sala 1B307) - CONTROLE INDIVIDUAL E DEFEITOS / DIMAN
  // 16 Computadores com ocorrências técnicas catalogadas para manutenção externa
  // ============================================================================

  // --- 1. MÁQUINAS JÁ ENVIADAS / SOLICITADAS À DIMAN ---
  {
    id: 'eq-sigeo-ws-089737',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089737)',
    code: 'WS-089737',
    patrimonio: '089737',
    category: 'workstation',
    status: 'manutencao_externa',
    description: 'Computador Workstation do Laboratório SIGEO (Sala 1B307) para ensino e processamento geoespacial.',
    specs: 'Intel Core i7 / 16GB RAM / HDD 500GB / GPU Dedicada',
    maintenanceReason: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD) - Encaminhado à DIMAN',
    maintenanceSince: '2026-09-10T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)',
    externalCompany: 'DIMAN - Diretoria de Manutenção (UFU)',
    externalServiceOrder: 'OS-DIMAN-2026/089737',
    externalExpectedReturn: '2026-09-30'
  },
  {
    id: 'eq-sigeo-ws-089747',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089747)',
    code: 'WS-089747',
    patrimonio: '089747',
    category: 'workstation',
    status: 'manutencao_externa',
    ...
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)',
    externalCompany: 'DIMAN - Diretoria de Manutenção (UFU)',
    externalServiceOrder: 'OS-DIMAN-2026/089747',
    externalExpectedReturn: '2026-09-30'
  },
  {
    id: 'eq-sigeo-ws-089816',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089816)',
    code: 'WS-089816',
    patrimonio: '089816',
    category: 'workstation',
    status: 'manutencao_externa',
    ...
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)',
    externalCompany: 'DIMAN - Diretoria de Manutenção (UFU)',
    externalServiceOrder: 'OS-DIMAN-2026/089816',
    externalExpectedReturn: '2026-09-30'
  },

  // --- 2. MÁQUINAS COM DEFEITO AGUARDANDO ENVIO À DIMAN ---
  {
    id: 'eq-sigeo-ws-089724',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089724)',
    code: 'WS-089724',
    patrimonio: '089724',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) com falha operacional.',
    specs: 'Intel Core i7 / 16GB RAM / HDD 500GB',
    maintenanceReason: 'Aguardando envio à DIMAN: Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-089742',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089742)',
    code: 'WS-089742',
    patrimonio: '089742',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-089820',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089820)',
    code: 'WS-089820',
    patrimonio: '089820',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-089802',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089802)',
    code: 'WS-089802',
    patrimonio: '089802',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-089818',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089818)',
    code: 'WS-089818',
    patrimonio: '089818',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-089741',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089741)',
    code: 'WS-089741',
    patrimonio: '089741',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-097843',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 097843)',
    code: 'WS-097843',
    patrimonio: '097843',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) com ausência de sinal de vídeo.',
    specs: 'Intel Core i7 / 16GB RAM / GPU Dedicada',
    maintenanceReason: 'Aguardando envio à DIMAN: Problema na geração de imagem (saída de vídeo / placa de vídeo)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-073780',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Desktop (Pat. 073780)',
    code: 'WS-073780',
    patrimonio: '073780',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) com incompatibilidade de arquitetura de sistema.',
    specs: 'Arquitetura de processamento legada / Necessita upgrade ou remanejamento',
    maintenanceReason: 'Aguardando envio à DIMAN: Arquitetura não suporta atualização de software (obsolescência técnica)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-078572',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Desktop (Pat. 078572)',
    code: 'WS-078572',
    patrimonio: '078572',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) com falha grave de disco rígido.',
    specs: 'Intel Core i7 / 16GB RAM / HDD 500GB com setores corrompidos',
    maintenanceReason: 'Aguardando envio à DIMAN: Defeito no HDD (disco rígido com setores corrompidos / falha de I/O)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-706070',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Desktop (Pat. 706070)',
    code: 'WS-706070',
    patrimonio: '706070',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) sem emissão de sinal de monitor.',
    specs: 'Intel Core i7 / 16GB RAM / GPU Dedicada',
    maintenanceReason: 'Aguardando envio à DIMAN: Problema na geração de imagem (saída de vídeo / falha na GPU)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-706064',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Desktop (Pat. 706064)',
    code: 'WS-706064',
    patrimonio: '706064',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-sigeo-ws-089743',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089743)',
    code: 'WS-089743',
    patrimonio: '089743',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) inoperante eletricamente.',
    specs: 'Intel Core i7 / 16GB RAM / Falha na placa-mãe ou fonte',
    maintenanceReason: 'Aguardando envio à DIMAN: Problema na placa-mãe ou fonte de alimentação (não inicializa)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
    id: 'eq-sigeo-ws-089815',
    labId: 'sigeo',
    name: 'Workstation SIGEO - Dell OptiPlex (Pat. 089815)',
    code: 'WS-089815',
    patrimonio: '089815',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do SIGEO (Sala 1B307) lacrado com defeito de vídeo.',
    specs: 'Intel Core i7 / 16GB RAM / Gabinete lacrado',
    maintenanceReason: 'Aguardando envio à DIMAN: Problema na geração de imagem (máquina lacrada - encaminhar diretamente à DIMAN)',
    maintenanceSince: '2026-09-16T08:00:00Z',
    assignedTechnician: 'Leonardo Cardoso (Sala 1B308)'
  },
  {
...
export const INITIAL_MAINTENANCE_REQUESTS: MaintenanceRequest[] = [
  // --- MÁQUINAS JÁ SOLICITADAS À DIMAN ---
  {
    id: 'man-diman-089737',
    protocol: 'MAN-DIMAN-089737',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089737',
    equipmentName: 'Workstation SIGEO (Pat. 089737)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Equipamento encaminhado à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
    status: 'em_manutencao',
    assignedTechnician: 'DIMAN - Diretoria de Manutenção (UFU)',
    technicianNotes: 'Chamado institucional formalizado. O.S. OS-DIMAN-2026/089737. Previsão de retorno em 30/09/2026.',
    createdAt: '2026-09-10T08:00:00Z',
    updatedAt: '2026-09-10T08:00:00Z'
  },
  {
    id: 'man-diman-089747',
    protocol: 'MAN-DIMAN-089747',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089747',
    equipmentName: 'Workstation SIGEO (Pat. 089747)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Equipamento encaminhado à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    ...
    status: 'em_manutencao',
    assignedTechnician: 'DIMAN - Diretoria de Manutenção (UFU)',
    technicianNotes: 'Chamado institucional formalizado. O.S. OS-DIMAN-2026/089747. Previsão de retorno em 30/09/2026.',
    createdAt: '2026-09-10T08:00:00Z',
    updatedAt: '2026-09-10T08:00:00Z'
  },
  {
    id: 'man-diman-089816',
    protocol: 'MAN-DIMAN-089816',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089816',
    equipmentName: 'Workstation SIGEO (Pat. 089816)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Equipamento encaminhado à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    ...
    status: 'em_manutencao',
    assignedTechnician: 'DIMAN - Diretoria de Manutenção (UFU)',
    technicianNotes: 'Chamado institucional formalizado. O.S. OS-DIMAN-2026/089816. Previsão de retorno em 30/09/2026.',
    createdAt: '2026-09-10T08:00:00Z',
    updatedAt: '2026-09-10T08:00:00Z'
  },

  // --- MÁQUINAS COM DEFEITO AGUARDANDO ENVIO À DIMAN ---
  {
    id: 'man-diman-089724',
    protocol: 'MAN-DIMAN-089724',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089724',
    equipmentName: 'Workstation SIGEO (Pat. 089724)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
    status: 'em_averiguacao',
    assignedTechnician: 'Leonardo Cardoso',
    technicianNotes: 'Aguardando coleta / envio formal à DIMAN (UFU).',
    createdAt: '2026-09-16T08:00:00Z',
    updatedAt: '2026-09-16T08:00:00Z'
  },
  {
    id: 'man-diman-089742',
    protocol: 'MAN-DIMAN-089742',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089742',
    equipmentName: 'Workstation SIGEO (Pat. 089742)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-089820',
    protocol: 'MAN-DIMAN-089820',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089820',
    equipmentName: 'Workstation SIGEO (Pat. 089820)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-089802',
    protocol: 'MAN-DIMAN-089802',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089802',
    equipmentName: 'Workstation SIGEO (Pat. 089802)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-089818',
    protocol: 'MAN-DIMAN-089818',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089818',
    equipmentName: 'Workstation SIGEO (Pat. 089818)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-089741',
    protocol: 'MAN-DIMAN-089741',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089741',
    equipmentName: 'Workstation SIGEO (Pat. 089741)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-097843',
    protocol: 'MAN-DIMAN-097843',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-097843',
    equipmentName: 'Workstation SIGEO (Pat. 097843)',
    urgency: 'alta',
    problemDescription: 'Problema na geração de imagem (saída de vídeo / placa de vídeo). Necessita diagnóstico DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
  ...
  {
    id: 'man-diman-073780',
    protocol: 'MAN-DIMAN-073780',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-073780',
    equipmentName: 'Workstation SIGEO (Pat. 073780)',
    urgency: 'media',
    problemDescription: 'Arquitetura não suporta atualização de software (obsolescência técnica). Necessita parecer da DIMAN para upgrade/baixa.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
  ...
  {
    id: 'man-diman-078572',
    protocol: 'MAN-DIMAN-078572',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-078572',
    equipmentName: 'Workstation SIGEO (Pat. 078572)',
    urgency: 'alta',
    problemDescription: 'Defeito no HDD (disco rígido com setores corrompidos / falha de I/O). Substituição por SSD requerida da DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
  ...
  {
    id: 'man-diman-706070',
    protocol: 'MAN-DIMAN-706070',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-706070',
    equipmentName: 'Workstation SIGEO (Pat. 706070)',
    urgency: 'alta',
    problemDescription: 'Problema na geração de imagem (saída de vídeo / falha na GPU). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
  ...
  {
    id: 'man-diman-706064',
    protocol: 'MAN-DIMAN-706064',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-706064',
    equipmentName: 'Workstation SIGEO (Pat. 706064)',
    urgency: 'alta',
    problemDescription: 'Problema na geração de imagem (saída de vídeo / falha na GPU). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  {
    id: 'man-diman-089743',
    protocol: 'MAN-DIMAN-089743',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089743',
    equipmentName: 'Workstation SIGEO (Pat. 089743)',
    urgency: 'critica',
    problemDescription: 'Problema na placa-mãe ou fonte de alimentação (não liga). Encaminhamento prioritário à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
  ...
  {
    id: 'man-diman-089815',
    protocol: 'MAN-DIMAN-089815',
    labId: 'sigeo',
    equipmentId: 'eq-sigeo-ws-089815',
    equipmentName: 'Workstation SIGEO (Pat. 089815)',
    urgency: 'alta',
    problemDescription: 'Problema na geração de imagem (máquina lacrada - encaminhar diretamente à DIMAN para preservação do lacre).',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
    applicantRole: 'tecnico',
    applicantId: 'usr-tech-01',
    status: 'em_averiguacao',
    assignedTechnician: 'Leonardo Cardoso',
    technicianNotes: 'Aguardando coleta / envio formal à DIMAN (UFU). Gabinete lacrado.',
    createdAt: '2026-09-16T08:00:00Z',
    updatedAt: '2026-09-16T08:00:00Z'
  }
];
...
export const INITIAL_EQUIPMENT_MOVEMENTS: EquipmentMovement[] = [
  // --- MOVIMENTAÇÕES DIMAN - Workstations SIGEO enviadas para manutenção externa ---
  {
    id: 'mov-diman-089737',
    equipmentId: 'eq-sigeo-ws-089737',
    patrimonio: '089737',
    ...
    originLocation: 'SIGEO - Sala 1B307',
    destinationLocation: 'DIMAN - Diretoria de Manutenção (UFU)',
    responsibleTechnician: 'Leonardo Cardoso',
    purpose: 'Manutenção Externa via DIMAN: Problema na fonte de alimentação / Defeito no HDD',
    generalNotes: 'Solicitação formalizada junto à DIMAN. O.S. OS-DIMAN-2026/089737. Gabinete completo com cabo de força.',
    status: 'em_transito',
    serviceOrder: 'OS-DIMAN-2026/089737',
    companyName: 'DIMAN - Diretoria de Manutenção (UFU)',
    accessories: 'Cabo de força, fonte ATX e HDD interno',
  ...
  },
  {
    ...
    responsibleTechnician: 'Leonardo Cardoso',
    purpose: 'Manutenção Externa via DIMAN: Problema na fonte de alimentação / Defeito no HDD',
    generalNotes: 'Solicitação formalizada junto à DIMAN. O.S. OS-DIMAN-2026/089747. Gabinete completo com cabo de força.',
    status: 'em_transito',
    serviceOrder: 'OS-DIMAN-2026/089747',
    companyName: 'DIMAN - Diretoria de Manutenção (UFU)',
    accessories: 'Cabo de força, fonte ATX e HDD interno',
    expectedReturnDate: '2026-09-30',
    createdAt: '2026-09-10T08:00:00Z'
  },
  {
    ...
    responsibleTechnician: 'Leonardo Cardoso',
    purpose: 'Manutenção Externa via DIMAN: Problema na fonte de alimentação / Defeito no HDD',
    generalNotes: 'Solicitação formalizada junto à DIMAN. O.S. OS-DIMAN-2026/089816. Gabinete completo com cabo de força.',
    status: 'em_transito',
    serviceOrder: 'OS-DIMAN-2026/089816',
    companyName: 'DIMAN - Diretoria de Manutenção (UFU)',
    accessories: 'Cabo de força, fonte ATX e HDD interno',
    expectedReturnDate: '2026-09-30',
    createdAt: '2026-09-10T08:00:00Z'
  ...
  // --- MOVIMENTAÇÕES LTGEO ANTERIORES ---
  {
    id: 'mov-001',
    patrimonio: '081814',
