...
export const INITIAL_EQUIPMENTS: Equipment[] = [
  ...
  // ============================================================================
  // WORKSTATIONS DO LABORATÓRIO LASER (Sala 1B309) - MANUTENÇÃO DIMAN
  // 16 Microcomputadores com ocorrências técnicas catalogadas
  // ============================================================================

  // --- 1. MÁQUINAS JÁ ENVIADAS / SOLICITADAS À DIMAN ---
  {
    id: 'eq-laser-ws-089737',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089737)',
    code: 'WS-089737',
    patrimonio: '089737',
    category: 'workstation',
    status: 'manutencao_externa',
    description: 'Computador Workstation do Laboratório LASER (Sala 1B309) para processamento óptico, fotogrametria e modelagem.',
  ...
  {
    id: 'eq-laser-ws-089747',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089747)',
    code: 'WS-089747',
    patrimonio: '089747',
    category: 'workstation',
    status: 'manutencao_externa',
  ...
  {
    id: 'eq-laser-ws-089816',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089816)',
    code: 'WS-089816',
    patrimonio: '089816',
    category: 'workstation',
    status: 'manutencao_externa',
  ...
  {
    id: 'eq-laser-ws-089724',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089724)',
    code: 'WS-089724',
    patrimonio: '089724',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) com falha operacional.',
  ...
  {
    id: 'eq-laser-ws-089742',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089742)',
    code: 'WS-089742',
    patrimonio: '089742',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-089820',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089820)',
    code: 'WS-089820',
    patrimonio: '089820',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-089802',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089802)',
    code: 'WS-089802',
    patrimonio: '089802',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-089818',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089818)',
    code: 'WS-089818',
    patrimonio: '089818',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-089741',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089741)',
    code: 'WS-089741',
    patrimonio: '089741',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-097843',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 097843)',
    code: 'WS-097843',
    patrimonio: '097843',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) com ausência de sinal de vídeo.',
  ...
  {
    id: 'eq-laser-ws-073780',
    labId: 'laser',
    name: 'Workstation LASER - Desktop (Pat. 073780)',
    code: 'WS-073780',
    patrimonio: '073780',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) com incompatibilidade de arquitetura de sistema.',
  ...
  {
    id: 'eq-laser-ws-078572',
    labId: 'laser',
    name: 'Workstation LASER - Desktop (Pat. 078572)',
    code: 'WS-078572',
    patrimonio: '078572',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) com falha grave de disco rígido.',
  ...
  {
    id: 'eq-laser-ws-706070',
    labId: 'laser',
    name: 'Workstation LASER - Desktop (Pat. 706070)',
    code: 'WS-706070',
    patrimonio: '706070',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) sem emissão de sinal de monitor.',
    specs: 'Intel Core i7 / 16GB RAM / GPU Dedicada',
  ...
  {
    id: 'eq-laser-ws-706064',
    labId: 'laser',
    name: 'Workstation LASER - Desktop (Pat. 706064)',
    code: 'WS-706064',
    patrimonio: '706064',
    category: 'workstation',
    status: 'manutencao',
  ...
  {
    id: 'eq-laser-ws-089743',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089743)',
    code: 'WS-089743',
    patrimonio: '089743',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) inoperante eletricamente.',
  ...
  {
    id: 'eq-laser-ws-089815',
    labId: 'laser',
    name: 'Workstation LASER - Dell OptiPlex (Pat. 089815)',
    code: 'WS-089815',
    patrimonio: '089815',
    category: 'workstation',
    status: 'manutencao',
    description: 'Computador Workstation do LASER (Sala 1B309) lacrado com defeito de vídeo.',
...
export const INITIAL_MAINTENANCE_REQUESTS: MaintenanceRequest[] = [
  // --- MÁQUINAS JÁ SOLICITADAS À DIMAN ---
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089737',
    equipmentName: 'Workstation LASER (Pat. 089737)',
    urgency: 'alta',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089747',
    equipmentName: 'Workstation LASER (Pat. 089747)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Equipamento encaminhado à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089816',
    equipmentName: 'Workstation LASER (Pat. 089816)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Equipamento encaminhado à DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  // --- MÁQUINAS COM DEFEITO AGUARDANDO ENVIO À DIMAN ---
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089724',
    equipmentName: 'Workstation LASER (Pat. 089724)',
    urgency: 'alta',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089742',
    equipmentName: 'Workstation LASER (Pat. 089742)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089820',
    equipmentName: 'Workstation LASER (Pat. 089820)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089802',
    equipmentName: 'Workstation LASER (Pat. 089802)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089818',
    equipmentName: 'Workstation LASER (Pat. 089818)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089741',
    equipmentName: 'Workstation LASER (Pat. 089741)',
    urgency: 'alta',
    problemDescription: 'Problema na fonte de alimentação / Defeito no HDD (Fonte/HDD). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-097843',
    equipmentName: 'Workstation LASER (Pat. 097843)',
    urgency: 'alta',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-073780',
    equipmentName: 'Workstation LASER (Pat. 073780)',
    urgency: 'media',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-078572',
    equipmentName: 'Workstation LASER (Pat. 078572)',
    urgency: 'alta',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-706070',
    equipmentName: 'Workstation LASER (Pat. 706070)',
    urgency: 'alta',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-706064',
    equipmentName: 'Workstation LASER (Pat. 706064)',
    urgency: 'alta',
    problemDescription: 'Problema na geração de imagem (saída de vídeo / falha na GPU). Necessita reparo pela DIMAN.',
    applicantName: 'Leonardo Cardoso',
    applicantEmail: 'leonardo.cardoso@ufu.br',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089743',
    equipmentName: 'Workstation LASER (Pat. 089743)',
    urgency: 'critica',
  ...
  },
  {
    ...
    labId: 'laser',
    equipmentId: 'eq-laser-ws-089815',
    equipmentName: 'Workstation LASER (Pat. 089815)',
    urgency: 'alta',
...
export const INITIAL_EQUIPMENT_MOVEMENTS: EquipmentMovement[] = [
  // --- MOVIMENTAÇÕES DIMAN - Workstations LASER enviadas para manutenção externa ---
  {
    id: 'mov-diman-089737',
    equipmentId: 'eq-laser-ws-089737',
    patrimonio: '089737',
